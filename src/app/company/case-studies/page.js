                ...
                >
                  <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-4 case-study-listing">
                      <article
                        id="post-76"
                        class="blog_row racing_cartel_header"
                      >
                        <div class="media">
                          <h4 class="media-heading">
                            <Link
                              href="/case-study/racing-cartel"
                              class="light_blue"
                            >
                              Racing Cartel
                            </Link>
                          ...
                          <div class="media-left">
                            <Image
                              width={300}
                              height={100}
                              src="https://www.logicspice.com/app/webroot/files/portfolio/thumb/4dc11_Racing_cartal.png"

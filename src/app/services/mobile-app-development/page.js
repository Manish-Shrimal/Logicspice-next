    ...
    <>
      ...
      <div class="mobileapp-deve_header environment">
        ...
        <div class="mobileapp-deve_header_in">
            <div class="image_of_inhand"><img alt="mobile app development compnay - logicspice" src="/img/mobileappdevelopment/phone_inhand_img.png" /></div>
        </div>
    </div>
    ...
    <div class="mobileapp-deve_bottom known-iphone">
    	<div class="wrapper">
    		<div class="devide_secs">
    			<div class="devide_secs_icn"><img alt="ios app development" src="/img/mobileappdevelopment/icon_bgicon.png" /></div>
    		...
    		<div class="devide_secs devide_secs_rrf">
    			<div class="devide_secs_icn"><img alt="Android App Development - logicspice" src="/img/mobileappdevelopment/icn_androidicn.png" /></div>
    			<div class="devide_secs_right">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-9 position-relative">
            <div class="mobil-bg_h">
                <img alt="mobil-bg" src="/img/mobileappdevelopment/mobil-bg_h.png" />
            </div>

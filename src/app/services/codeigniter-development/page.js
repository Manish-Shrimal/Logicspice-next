...
const Page = () => {
  ...
  return (
    <>
      ...
      <section class="laravel-banner codeIgniter-banner">
        <div class="container">
          <div class="row">
      ...
      <section class="laravel-descriptions codeigniter-descriptions">
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6 pull-left">
              <div class="laravel-descriptions-bx">
                ...
                <p>
                  CodeIgniter is the one of the most preferred platforms in the
                  Open Source Development works in the world. Budding and well
                  established companies are flocking towards CodeIgniter
                ...
                <p>
                  ...
                  Open Source development projects. Its exceptional approach and
                  correct environment provides optimal solutions to the
                  requirements. Logicspice is a leading company when it comes to
                  offer world class quality CodeIgniter development services.{" "}
                  <b>CodeIgniter web service </b> promotes utilization of its
                  fertile framework to its fullest.
                </p>

                <p>
                  Logicspice is codeigniter development company who has a great
                  users experience gives an exceptional liberty to play with
                  their creativity and logics with zero struggles in
                  comprehending the interface. Our features have been programmed
                  to suit the latest trends and have been well defined to meet
                  the growing requirements of users and their uses.
                </p>

                <p>
                  Hire CodeIgniter developers and avail the benefits from a team
                  of diverse developers. The developers and coders have been
                  ...
                  inventive outcomes. Our softwares are assorted over a diverse
                  range with result oriented goals. It serves as a platform for
                  both big and small enterprises through its multifaceted
                  payment gateway options.{" "}
                  <b>CodeIgniter Web Development Company</b> has been a part to
                  diverse projects arising from almost every industrial aspect.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="laravel_service_box ">
                  ...
                  <p>
                    CodeIgniter is a comprehensible and powerful open source web
                    application framework enabling development of modular
                    extensions.
                  </p>
                </div>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="laravel_service_box ">
                  ...
                  <p>
                    We offer brilliant developers with exceptional web designing
              ...
              <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="laravel_service_box ">
                  ...
                  <p>
                    Our work extends beyond our relationship which is reflected
                    through 24X7 professional support and maintenance services.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section class="laravel_core_features_section codeigniter_core_features_section">
        <div class="container">
              ...
              <div class="col-sm-6 col-md-6" data-aos="fade-right">
                <div class="libraries_laravel_choose">
                  ...
                  <div class="laravel_choose_details">
                    ...
                    <p>
                      CodeIgniter solutions provide a MVC controlled framework.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-md-6" data-aos="fade-left">
                <div class="libraries_laravel_choose libraries_laravel_choose-right">
                  ...
                  <div class="laravel_choose_details">
                    ...
                    <p>
                      The access provided by CodeIgniter development services is
                      highly secured and filtered using Cross-site scripting or
                      XSS.
                    </p>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-md-6 " data-aos="fade-right">
                <div class="libraries_laravel_choose">
                  ...
                  <div class="laravel_choose_details">
                    ...
                    <p>
                      It provides high level of customization support and faster
                      development.
                    </p>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-md-6" data-aos="fade-left">
                <div class="libraries_laravel_choose libraries_laravel_choose-right">
                  ...
                  <div class="laravel_choose_details">
                    ...
                    <p>
                      CodeIgniter offers alluring theme designing services which
                      are dynamic and always available to adorn your ecommerce
                      websites.
                    </p>
                  </div>
                </div>

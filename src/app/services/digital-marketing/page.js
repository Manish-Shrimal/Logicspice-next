            ...
            <div className="row">
              ...
              <div className="col-md-6 col-sm-12 col-xs-12">
                <div className="ims-content">
                  <h3>
                    <span>1</span> <strong>Internet Marketing Solutions</strong>
                  </h3>
                  <p>
                  ...
                  <ul>
                    ...
                    <li>
                      Optimization analysis of conversion on regular intervals.
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="row">
              ...
              <div className="col-md-6 col-sm-12 col-xs-12">
                <div className="ims-content">
                  ...
                  <p>
                    This is probably the most important thing for any company to
                    create a reputation on various platforms. Brand development
                    performs this job for you with absolute perfection by making
                    use of the Google and Facebook Ads that can help create a
                    reputation of your brand in a short span of time.
                  </p>

                  <ul>
                    <li>
                      Google and Facebook ads from certified developers that can
              ...
              <div className="col-md-6 col-sm-12 col-xs-12 pull-left">
                <div className="ims-content">
                  ...
                  <p>
                    ...
                    on the audience by helping you amongst the first few search
                    options.{" "}
                  </p>

                  <ul>
                    <li>
                      Organic techniques for rank improvement and optimization.{" "}
                    </li>
                    <li>
                      Transparent techniques to avoid spamming that can get your
                      website banned.{" "}
                    </li>

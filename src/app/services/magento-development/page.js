                ...
                <div className="col-sm-6 col-md-6 pull-left">
                    ...
                    <div className="laravel-descriptions-bx">
                        ...
                        <p>Magento is an astounding open source ecommerce development platform. The developers of Magento provide a significant addition to their users with an assortment of 
                            choices and development options catered by the Magento and we as a 
                            <a href="https://www.logicspice.com/web-development" target="_blank" >web development company</a> 
                            can customize them to meet any specific requirements of customization. 
                            Magento web development is rendered via a MVC or Model View Controller&sbquo; EAV or Entity Attribute Value model and database. Magento presents its users with a large 
                            number of alternatives to its users which was not a common practice at earlier frameworks. Magento has become the most preferred ecommerce platform developer with 
                            over 150&sbquo;000 sites rendered under its framework.</p>
                        <p>Magento <a href="https://www.logicspice.com/website-design" target="_blank">website designing</a> 
                            and custom development services have been utilized by many leading enterprises. We provide our clients with a larger choice base than any 
                            other framework developer.</p>
    
                        <p> LogicSpice has utilized the developers of Magento Development Services to its fullest. Websites built by our Magento ecommerce development workers are stable&sbquo; have a
                            flexible scalability and a large reach. Websites built by <b>Magento ecommerce development</b> workers are stable&sbquo; have a flexible scalability and a large reach. Our
                            developers have inculcated dynamic factors in every project that went through their hands. These dynamic features include transaction portals&sbquo; transactions
                            alternatives&sbquo; multi-faceted functionality&sbquo; loyalty programs&sbquo; categorized overview&sbquo; etc. These features help ecommerce websites to meet the ever changing and
                            varying needs of customers.</p>
                    </div>
                </div>
                ...
                <div className="row">
                    ...
                    <div className="col-xs-12 col-sm-6 col-md-3">
                        <div className="laravel_service_box ">
                            ...
                            <p>Our highly satisfying customization service will meet the needs of your ecommerce page.</p>
                        </div>
                    </div>
                    ...
                    <div className="col-xs-12 col-sm-6 col-md-3">
                        <div className="laravel_service_box ">
                            ...
                            <p>Smooth payment portals and easy checkout is one of our specializations.</p>
                        </div>
                    </div>
                    ...
                    <div className="col-xs-12 col-sm-6 col-md-3">
                        <div className="laravel_service_box ">
                            ...
                            <p>Our renowned web development services are always ready to cater to your needs no matter how intricate they are.</p>
                        </div>
                    </div>
                    ...
                    <div className="col-xs-12 col-sm-6 col-md-3">
                        <div className="laravel_service_box ">
                            ...
                            <p>Magento web designing services present our clients with alluring framework designs which will attract more users.</p>
                        </div>
                    </div>
                    ...
                    <div className="col-xs-12 col-sm-6 col-md-3">
                        <div className="laravel_service_box ">
                            ...
                            <p>Our Magento Website Development company also provides for migration between the different platforms.</p>
                        </div>
                    </div>

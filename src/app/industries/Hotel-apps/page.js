            ...
            <div class="row">
              ...
              <div class="col-md-6 text-center">
                <div class="text-center hotel-info">
                  ...
                  <div class="Travel_and">Travel &amp; Hospitality</div>
                  ...
                  <div class="portfolio_button_center">
                    ...
                    <a class="btn btn-primary" onClick={toggleModal}>Enquire Now</a>
            ...
            <div class="col-md-8">
              <div class="hotel_description_content">
                <h1 class="hotel_description_title">
                  ...
                  <span> Travel & Hospitality Industry </span>
                </h1>
                    ...
                    <div class="casestudy-row" id="post-3343">
                      ...
                      <div class="case-col-detail">
                        ...
                        <div class="casestudy-details-para">
                          <p>
                            Yolodome.com is an online travel website that
                            provides users with facility to book a place to
                            stay. Users can search for suitable rental places
                            across the world. This website provides dif...
                          </p>
                          <a href="">Read More</a>
                        </div>
                      </div>
                    ...
                    <div class="casestudy-row" id="post-3343">
                      <div class="case-col-img">
                        <Image
                          width={300}
                          height={100}
                          src="/img/globalpages/9d27c_iamcooking.png"
                          alt="Iamcooking - logicspice"
                        />
                      </div>
                      <div class="case-col-detail">
                        <h3 class="casestudy-title">
                          <a href="">
                            <span>Iamcooking</span>
                          </a>
                        </h3>

                        <div class="casestudy-details-para">
                          <p>
                            Iamcooking Iamcooking that we are scoping will
                            serves as Online Food Ordering Website using custom
                            framework (PHP) that will facilitate a shoppers to
                            do place order by choosing items as p...
                          </p>
                          <a href="">Read More</a>
                        </div>
                      </div>
                ...
                <div class="blog_head" id="post-3498">
                  <div class="blog_head_img">
                    <Image
                      width={700}
                      height={100}
                      src="/img/globalpages/420f5_How-Much-Would-It-Cost-To-Develop-A-Food-Delivery-App-On-Android---IOS-.png"
                      alt="How much would it cost To develop a food delivery app on Android and iOS ?"
                    />
                  </div>
                  <div class="blog_head_detail">
                    ...
                    <div class="blog_details">
                      There are few fundamental expenses included in developing
                      a Food Delivery app for iOS and android and we here at
                      Logicspice bear the few which are- Developer’s expenses :-
                      They take normal

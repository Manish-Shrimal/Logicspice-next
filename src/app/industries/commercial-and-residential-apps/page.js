            ...
            <div class="col-md-8">
              <div class="hotel_description_content">
                <h1 class="hotel_description_title">
                  ...
                  <span> Commercial & Real Estate Industry </span>
                </h1>
                ...
                <p style={{ textAlign: "justify" }}>
                  If are you looking for ready to launch property rental
                  software to start a rental property business in your budget,
                  we offer best
                  <a href="">property management rental software</a>, which
                  allows property owners to post details about their property
                  and manage requests received by them for rent. It can help you
                  manage your Residential Rental Properties.
                </p>
              </div>
            </div>
            <div class="col-md-4">
        ...
        <div class="container">
          ...
          <div class="tab-content">
            ...
            {selectedTab === "why_we_need" && (
              <div role="tabpanel" class="tab-pane" id="why_we_need">
                <div class="tab_para">
                  <p>

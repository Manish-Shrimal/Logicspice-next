            ...
            <div class="row">
              ...
              <div class="col-md-6 text-center">
                <div class="text-center hotel-info">
                  ...
                  <div class="Travel_and">ENERGY & UTILITIES</div>
            ...
            {selectedTab === "why_we_need" && (
              <div role="tabpanel" class="tab-pane" id="why_we_need">
                <div class="tab_para">
                  ...
                  <ul class="listtupe">
                    <li>
                      <b>Efficient Service Management – </b>Real-time updates on
                      service schedules and outages.
                    </li>
                    <li>
                      <b>User-Centric Design – </b> Features like usage
                      tracking, bill payments, and support queries make it
                      user-friendly.
                    </li>
                    <li>
                      <b>Prompt Alerts – </b>Immediate notifications for service
                      updates and energy-saving tips.
                    </li>
                    <li>
                      <b>Loyalty Incentives –</b> Apps can offer rewards for
                      energy-saving behaviors and timely bill payments.
                    </li>
                    <li>
                      <b>Smart Home Integration – </b>Control and monitor home
                      energy devices directly from the app.
                    </li>
                    <li>
                      <b>Secure Payment Gateways – </b>Simplified and secure
                      methods for bill payments and other transactions.
                    </li>
                  </ul>
                </div>
              </div>

            ...
            <div className="row">
              ...
              <div className="col-md-6 text-center">
                <div className="text-center hotel-info">
                  ...
                  <div className="Travel_and">FINANCE & INSURANCE SERVICES</div>
            ...
            <div className="col-md-8">
              <div className="hotel_description_content">
                <h1 className="hotel_description_title">
                  ...
                  <span> Finance & Insurance Industry </span>
                </h1>
                    ...
                    <div className="casestudy-row" id="post-3343">
                      <div className="case-col-img">
                        <Image
                          width={300}
                          height={100}
                          src="/img/globalpages/9d3bb_uloan.png"
                          alt="uLoan-logicspice"
                        />
                      </div>
                      <div className="case-col-detail">
                        <h3 className="casestudy-title">
                        ...
                        <div className="casestudy-details-para">
                          <p>
                            ...
                            Application by providing financial information.
                            uLoan will use that information to assess the
                            borrowers loan request. This may include upl...
                          </p>
                          <a href="">Read More</a>
                        </div>
                      </div>
                    ...
                    <div className="casestudy-row" id="post-3343">
                      <div className="case-col-img">
                        <Image
                          width={300}
                          height={100}
                          src="/img/globalpages/f24ff_your_pantion.png"
                          alt="Pension Plan Management-logicspice"
                        />
                      </div>
                      <div className="case-col-detail">
                        <h3 className="casestudy-title">
                          <a href="">
                            <span>Pension Plan Management</span>
                          </a>
                        </h3>

                        <div className="casestudy-details-para">
                          <p>
                            The website “Your Pension” facilitates the users to
                            administer the Employee keep track of their pension
                            funds. There are 4 user mode over the website, i.e.
                            administrator, Employer (HR Dep...
                          </p>
                          <a href="">Read More</a>
                        </div>
                      </div>
                ...
                <div className="blog_head" id="post-3498">
                  <div className="blog_head_img">
                    <Image
                      width={700}
                      height={100}
                      src="/img/globalpages/2dcec_Tips-To-Hire-Best-Drupal-Development-Company.jpg"
                      alt=" Tips To Hire Best Drupal Development Company"
                    />
                  </div>
                  <div className="blog_head_detail">
                    <h3 className="entry-title heading_subsiti">
                      <a href="">
                        <span>
                          {" "}
                          Tips To Hire Best Drupal Development Company{" "}
                        </span>
                      </a>
                    </h3>
                    <div className="method_blog">
                      <ul>
                        ...
                        <li>
                          ...
                          <span>
                            <a href="" title="web development company">
                              web development company
                            </a>
                            ,
                            <a href="" title="hire drupal experts">
                              hire drupal experts
                            </a>
                            ,
                            <a href="" title="drupal development services">
                    ...
                    <div className="blog_details">
                      In the current scenario Drupal is the key content
                      management system available in the market across the
                      globe. It is one such system that is being opted by
                      professionals for developing an efficacious

    ...
    <>
            ...
            <div class="row">
              ...
              <div class="col-md-6 text-center">
                <div class="text-center hotel-info">
                  ...
                  <div class="Travel_and">ONLINE EDUCATION</div>
              ...
              <div class="row">
                <div class="col-md-3 col-sm-4">
                  <div class="casestudy-col">
                    <div class="casestudy-row" id="post-3343">
                      <div class="case-col-img">
                        <Image
                          width={300}
                          height={100}
                          src="/img/onlineeducation/fourstroke.png"
                          alt="FourStrokesCoaching - logicspice"
                        />
                      </div>
                      <div class="case-col-detail">
                        <h3 class="casestudy-title">
                          <a href="">
                            <span>FourStrokesCoaching</span>
                          </a>
                        </h3>

                        <div class="casestudy-details-para">
                          <p>
                            Four strokes coaching is an online website to
                            provide tutorials for the swimming. It provide user
                            with swim workout, interval calculator, swim ratio
                            test, drill videos, gym exercise and o...
                          </p>
                          <a href="">Read More</a>
                        </div>
                      </div>
                    ...
                    <div class="casestudy-row" id="post-3343">
                      <div class="case-col-img">
                        <Image
                          ...
                          alt="AskOurEinstein - logicspice"
                        />
                      </div>
                      <div class="case-col-detail">
                        <h3 class="casestudy-title">
                          <a href="">
                            <span>AskOurEinstein</span>
                          </a>
                        </h3>

                        <div class="casestudy-details-para">
                          <p>
                            &quot;AskOurEinstein&quot; is a tutoring website,
                            which will provide tutoring service. Tutors from all
                            areas of academic including math, science,
                            engineering, chemistry, accounting, finance,
                            biolog...
                          </p>
                          <a href="">Read More</a>
                        </div>
                    ...
                    <div class="casestudy-row" id="post-3343">
                      <div class="case-col-img">
                        <Image
                          width={300}
                          height={100}
                          src="/img/globalpages/MyUtrack.png"
      ...
      <section class="blog_sections">
        <div class="container">
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="blogstudy-th">
                <div class="blog_head" id="post-3498">
                  <div class="blog_head_img">
                    <Image
                      width={700}
                      height={100}
                      src="/img/globalpages/8b816_Catching-Up-With-Wordpress-Development.jpg"
                      alt=" Catching Up With Wordpress Development"
                    />
                  </div>
                  <div class="blog_head_detail">
                    <h3 class="heading_subsiti">
                      <a href="">
                        <span> Catching Up With Wordpress Development </span>
                      </a>
                    </h3>
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          <span>
                            ...
                            ,
                            <a href="" title="wordpress development services">
                              wordpress development services
                            </a>
                            ,
                            <a href="" title="wordpress development company">
                              wordpress development company
                            </a>
                            ,
                            <a href="" title="customized web development">
                    ...
                    <div class="blog_details">
                      WordPress is one of the most popular and growing content
                      management systems for enterprises to design their
                      websites and as an open source blogging systems for
                      individuals to manage their blogs.
                ...
                <div class="blog_head" id="post-3498">
                  <div class="blog_head_img">
                    <Image
                      width={700}
                      height={100}
                      src="/img/globalpages/How%20much%20does%20it%20cost%20to%20make%20an%20educational%20app%20for%20students.jpg"
                      alt=" How Much Does It Cost To Build An Educational App For Students ?"
                    />
                  </div>
                  <div class="blog_head_detail">
                    <h3 class="entry-title heading_subsiti">
                      <a href="">
                        <span>
                          How Much Does It Cost To Build An Educational App For
                          Students ?
                        </span>
                      </a>
                    </h3>
                    <div class="method_blog">
                      <ul>
                        ...
                        <li>
                          <i class="fa fa-tag" aria-hidden="true"></i>
                          <span>
                            <a href="" title="education apps development">
                              education apps development
                            </a>
                            ,
                            <a
                              href=""
                              title="education apps development company"
                            >
                              education apps development company
                            </a>
                            ,
                            <a href="" title="education mobile apps">
                              education mobile apps
                            </a>
                            ,{" "}
                            <a href="" title="learning apps">
                              learning apps
                            </a>
                            ,
                            <a href="" title="e-learning apps">
                              e-learning apps
                            </a>
                            ,
                            <a href="" title="app cost calculator">
                              app cost calculator
                            </a>
                          </span>
                        </li>
                    ...
                    <div class="blog_details">
                      An educational app can trigger the overall progression
                      rate of the students. It adds value to the educational
                      experience by simplifying the complex educational concepts
                      manifold. Today, we are
                      <a href="" class="blog_read_more" title="read more">
                        read more
                      </a>
                    </div>
        ...
        <div class="container">
          ...
          <div class="tab-content">
            {selectedTab === "about_app" && (
              <div role="tabpanel" class="tab-pane active" id="about_app">
                <div class="row">

...
const Page = () => {
  ...
  return (
    <>
      <Navbar />
      <section className="country_header_secton Transportation">
                    ...
                    <article className="blog_row" id="post-3343">
                      <div className="blog_row_img">
                        <Image
                          width={300}
                          height={100}
                          src="/img/globalpages/40c42_jv-post.png"
                      ...
                      <div className="blog_row_detail">
                        ...
                        <div className="blog_detail_sectc_bl">
                          <p>
                            ...
                            customers to place the request for pick & delivery
                            the package over the application by specify...
                          </p>
                          <a href="">Read More</a>
                        </div>
                      </div>
                ...
                <div className="blog_head" id="post-3498">
                  <div className="blog_head_img">
                    <Image
                      width={700}
                      height={100}
                      src="/img/globalpages/e8409_Taxi-Hailing-Apps-For-a-Taxi-Business.png"
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          <span>
                            ...
                            ,
                            <a href="" title="mobile booking apps">
                              mobile booking apps
                            </a>
                          </span>
                        </li>
                ...
                <div className="blog_head" id="post-3498">
                  <div className="blog_head_img">
                    <Image
                      width={700}
                      height={100}
                      src="/img/globalpages/10043_How-Much-Does-It-Cost-To-Build-an-E-Commerce-App-For-Business.png"

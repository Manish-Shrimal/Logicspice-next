...
const Page = () => {
  ...
  return (
    <>
      <Navbar />
      <section
        class="resources-header CareerBanners"
        style={{
          background:
              ...
              <div class="content_left_bar_resources">
                ...
                <div class="entry-content-page">
                  ...
                  <ul class="webvevtwo">
                    ...
                    <li>
                      <div
                        class="kno-ecr-pt kno-fb-ctx MWz3cf"
                  ...
                  <p class="CareersBtn">
                    <Link href="/company/apply-now'" class="btn btn-primary">
                      Submit Your Resume
                    </Link>
                    <Link
                      href="/company/applicationform'"
                      class="btn btn-primary vieus oid"
                    >

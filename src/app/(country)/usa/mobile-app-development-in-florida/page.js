...
const Page = () => {
  ...
  return (
    <>
      <Navbar />
      <section className="country_header_secton florida">
            ...
            <div className="col-md-8">
              <div className="mobileapp_devcountry_bx_left">
                <h1 className="mobileapp_devcountry_bx_left_title">
                  Mobile App Development Company In <span>Florida</span>
                </h1>
                <p style={{ textAlign: "justify" }}>
                  ...
                  mobile apps and provide best app developemt services in
                  florida and all other mazor countries. Our expert app
        ...
        <section className="acquainted">
          <div className="container">
            ...
            <p>
              ...
              Florida, USA and have a team of expert app developers who can

...
const Page = () => {
  ...
  return (
    <>
      {" "}
      <Navbar />
      <section class="country_header_secton losangeles">
            ...
            <div class="col-md-8">
              <div class="mobileapp_devcountry_bx_left">
                <h1 class="mobileapp_devcountry_bx_left_title">
                  Mobile App Development Company In <span>Los Angeles</span>
                </h1>
                <p style={{ textAlign: "justify" }}>
                  ...
                  mobile apps and provide best app developemt services in los
                  angeles and all other mazor countries. Our expert app
                  developers strive hard to develop best quality apps with
                  offers complete End-To-End custom features.
                </p>
                <p style={{ textAlign: "justify" }}>
        ...
        <section class="acquainted">
          <div class="container">
            ...
            <p>
              ...
              Los Angeles, USA and have a team of expert app developers who can
                ...
                <div class="row">
                  <div class="col-sm-6 pull-right">
                    <div class="sectionset_iosands_col sectionset_iosands_colcon">
                      ...
                      <div class="descectionset_iosands" dir="ltr">

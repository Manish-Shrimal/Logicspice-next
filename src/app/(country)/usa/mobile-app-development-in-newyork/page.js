...
const Page = () => {
  ...
  return (
    <>
      <Navbar />
      <section className="country_header_secton newyork">
            ...
            <div className="col-md-8">
              <div className="mobileapp_devcountry_bx_left">
                <h1 className="mobileapp_devcountry_bx_left_title">
                  Mobile App Development Company In <span>New York</span>
                </h1>
                <p style={{ textAlign: "justify" }}>
                  ...
                  mobile apps and provide best app developemt services in new
                  york and all other mazor countries. Our expert app developers

...
const Page = () => {
  ...
  return (
    <>
      {" "}
      <Navbar />
      <section className="country_header_secton uae">
            ...
            <div className="col-md-8">
              <div className="mobileapp_devcountry_bx_left">
                <h1 className="mobileapp_devcountry_bx_left_title">
                  Mobile App Development Company In <span>UAE</span>
                </h1>
        ...
        <section className="acquainted">
          <div className="container">
            ...
            <p>
              ...
              UAE and have a team of expert app developers who can serve you for

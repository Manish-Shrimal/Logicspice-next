...
const Page = () => {
  ...
  return (
    <>
      <Navbar />
      <section className="country_header_secton abudhabi">
            ...
            <div className="col-md-8">
              <div className="mobileapp_devcountry_bx_left">
                <h1 className="mobileapp_devcountry_bx_left_title">
                  Mobile App Development Company In <span>Abu Dhabi</span>
                </h1>
      ...
      <section className="creativity">
        <div className="container">
          ...
          <p>
            ...
            of UAE. App developed by logicspice help businesses to enhance their
      ...
      <section>
        ...
        <section className="acquainted">
          <div className="container">
            <h3 className="mobileapp_devcountry_bx_left_title">
              We Have Served Our Clients In UAE
            </h3>
            <p>
              ...
              Dubai, UAE and have a team of expert app developers who can serve
                ...
                <div className="row">
                  <div className="col-md-4">
                    <Image
                      ...
                      height={100}
                      unoptimized={true}
                      src="/img/globalpages/iTenderYou.png"
                      alt="..."
                  ...
                  <div className="col-md-8">
                    <h4>iTenderyou</h4>
                    <p>
                      itenderyou, provides a platform for users to post items by
                      selecting category & submitting details of auction item
                      over the site. User as a Seller can invite other users for
                      posting bids over the site.Users as a buyer will be able
                      to view invites and can view details of auction over the
                      site. Users as a buyer will be able to view details of a
                      particular item{" "}
                ...
                <div className="row">
                  <div className="col-md-4">
                    <Image
                      ...
                      height={100}
                      unoptimized={true}
                      src="/img/globalpages/CourseTakers.png"
                      alt="..."
                      className="img-thumbnail"
                    />
                  </div>
                  <div className="col-md-8">
                    <h4>Course Takers</h4>
                    <p>
                      "CourseTakers" is an interactive medium for course givers
                      to advertise their courses and course takers can easily
                      search for courses available on website, view their entire
                      details and book them online by making payment online or
                      selecting Cash on delivery option. After attending the
                      booked course, course taker will receive an email
                      notification to rate that{" "}
                  ...
                  <div className="slide">
                    ...
                    <div className="right_side_testi">
                      ...
                      <div className="cilent_text">
                        ...
                        capability of PhpMaestro. They are just wonderful and
                ...
                <div className="ClientSlideBx">
                  <div className="row">
                    ...
                    <div className="col-md-8">
                      <h4>iTenderyou</h4>
                      <p>
                        itenderyou, provides a platform for users to post items
                        by selecting category & submitting details of auction
                        item over the site. User as a Seller can invite other
                        users for posting bids over the site.Users as a buyer
                ...
                <div className="ClientSlideBx">
                  <div className="row">
                    ...
                    <div className="col-md-8">
                      <h4>Course Takers</h4>
                      <p>
                      &quot;CourseTakers&quot; is an interactive medium for course
                        givers to advertise their courses and course takers can
                        easily search for courses available on website, view
                        their entire details and book them online by making

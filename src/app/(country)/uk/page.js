...
const Page = () => {
  ...
  return (
    <>
      {" "}
      <Navbar />
      <section className="country_header_secton uk">
            ...
            <div className="col-md-8">
              <div className="mobileapp_devcountry_bx_left">
                <h1 className="mobileapp_devcountry_bx_left_title">
                  Mobile App Development Company In <span>UK</span>
                </h1>
                <p style={{ textAlign: "justify" }}>
                  Logicspice, the UK development company is specialized in
                  mobile app development that puts the user’s first and deliver
                  a great digital experience. We deliver the most successful
                  apps that offer an outstanding user experience and business
                  transformation result.
                </p>
                <p style={{ textAlign: "justify" }}>
                  Logicspice believes in constantly refining process to produce
                  the effective apps for engaging more customers. Our developed
                  apps have always hit the play store first. We work with the
                  commitment to customer satisfaction and delivering the project
                  on given time and budget..
                </p>
              </div>
            </div>

...
const Page = () => {
  ...
  return (
    <>
      {" "}
      <Navbar />
      <section className="country_header_secton london">
            ...
            <div className="col-md-8">
              <div className="mobileapp_devcountry_bx_left">
                <h1 className="mobileapp_devcountry_bx_left_title">
                  Mobile App Development Company In <span>London</span>
                </h1>
                <p style={{ textAlign: "justify" }}>
                  Logicspice is one of the world’s leading mobile app
                  development companies. The combination of functionality with
                  best design is our functionality. At Logicspice London, our
                  mobile app developers take your idea and convert it into a
                  stunning mobile app that users will love. Our focus is on
                  product driven apps rather than campaign driven apps.
                </p>
                <p style={{ textAlign: "justify" }}>
                  We offer most advance, beautiful and great user experience
                  app. We want to help the client to bring something advance to
                  the world. We want you to use your skills fully.
                </p>
              </div>
            </div>

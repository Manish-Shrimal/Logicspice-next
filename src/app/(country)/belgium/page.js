...
const Page = () => {
  ...
  return (
    <>
    <Navbar />
      <section class="country_header_secton Belgium">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="text-center main-ind-text">
                  ...
                  <div class="country_header_secton_right_countryname">
                    Belgium
                  </div>
            ...
            <div class="col-md-8">
              <div class="mobileapp_devcountry_bx_left">
                <h1 class="mobileapp_devcountry_bx_left_title">
                  Mobile App Development Company In <span>Belgium</span>
                </h1>
                ...
                <div className="row">
                  ...
                  <div className="col-md-8">
                    ...
                    <p>
                      ...
                      Buyer would be able to upload there CVs and would be able
                      to capture the video resume or requirement in the form of
                ...
                <div className="row">
                  ...
                  <div className="col-md-8">
                    ...
                    <p>
                      ...
                      provide a platform to the event planners/hosts and artists
                      (Actors, Musicians, and Speakers) to get in touch with
                      each other. This website will facilitate event planners
                      and artists to register over the website. Where artists
                  ...
                  <div className="slide">
                    ...
                    <div className="right_side_testi">
                      ...
                      <div className="cilent_text">
                        ...
                        platform. The developers are very good and the codes are
                        clean. So far, they have always been able to meet our
                        requirements and make their best to satisfy us. They
                        should just pay more attention to design details. I will
                        clearly continue working with them in the future if
                        their prices remain in line with the Market average. We
                        know that we can trust them and this is a very important
                        point for us. Thanks for the good work, Olivier&quot;
                      </div>
                      <div className="cilent_name">
                        <span>
                          <strong className="flag">

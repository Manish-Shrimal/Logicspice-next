...
const Page = () => {
  ...
  return (
    <>
      <Navbar />
      <section className="country_header_secton zurich">
            ...
            <div className="col-md-8">
              <div className="mobileapp_devcountry_bx_left">
                <h1 className="mobileapp_devcountry_bx_left_title">
                  Mobile App Development Company In <span>Zurich</span>
                </h1>
                ...
                <div className="ClientSlideBx">
                  <div className="row">
                    ...
                    <div className="col-md-8">
                      ...
                      <p>
                        The motto of &quot;Pension Plan Management&quot; web
                        solution is to provide online viewing portfolio that
                        will be offered by administrator that would be a User
                        Centric, User Oriented and would be easy to navigate and
                        use. The objective of the proposed web solution is to
                        develop effective services Choose LogicSpice for its
                        ability to develop for complex websites, and the first
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-8">
                      ...
                      <p>
                        ...
                        application for customers to find nearby coffee shops
                        and place order over app. This multilingual app (Android
                        & iPhone) facilitates customers to view their nearby
                        coffee shops and can thus checkout for their favorite
                  ...
                  <div className="testimonial-country">
                    <div className="slide">
                      ...
                      <div className="right_side_testi">
                        ...
                        <div className="cilent_text">
                          &quot;Everything was very good, they gave their best
                          till we was happy with the app. At the end of the
                          project, we had a great user friendly app.&quot;
                        </div>
                        <div className="cilent_name">
                          <span>
                            <strong className="flag">

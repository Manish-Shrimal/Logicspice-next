...
const Page = () => {
  ...
  return (
    <>
      <Navbar />
      <section className="country_header_secton switzerland">
            ...
            <div className="col-md-8">
              <div className="mobileapp_devcountry_bx_left">
                <h1 className="mobileapp_devcountry_bx_left_title">
                  Mobile App Development Company In <span>Switzerland</span>
                </h1>
      ...
      <section className="creativity">
        <div className="container">
          ...
          <p>
            ...
            of Switzerland. App developed by logicspice help businesses to
            enhance their brand presence, trust, loyalty among the current and
      ...
      <section>
        ...
        <section className="acquainted">
          <div className="container">
            <h3 className="mobileapp_devcountry_bx_left_title">
              We Have Served Our Clients In Switzerland
            </h3>
            <p>
              ...
              Switzerland and have a team of expert app developers who can serve
                  ...
                  <div className="row">
                    <div className="col-md-4">
                      <Image
                        ...
                        height={100}
                        unoptimized={true}
                        src="/img/globalpages/yourpension.jpg"
                        alt="..."
                    ...
                    <div className="col-md-8">
                      ...
                      <p>
                        The motto of &quot;Pension Plan Management&quot; web solution is
                        to provide online viewing portfolio that will be offered
                        by administrator that would be a User Centric, User
                        Oriented and would be easy to navigate and use. The
                        objective of the proposed web solution is to develop
                        effective services Choose LogicSpice for its ability to
                    ...
                    <div className="slide">
                      {/* <!--                        <div className="left_side_testi">
                            <div className="cilent_img"> 
                                <Image width={100} height={100} unoptimized={true} src="/img/globalpages/clients/beatbuehlmann.png" alt="">                          </div> 
                            <div className="cilent_name">
                                <span><strong className="flag"><Image width={100} height={100} unoptimized={true} src="/img/globalpages/swj.png" /></strong> Beatbuehlmann </span>
                      ...
                      <div className="right_side_testi">
                        ...
                        <div className="cilent_text">
                          &quot;Excellent work again from phpMaestro! They definitely
                          put their best effort into the project along with very
                          valuable inputs regarding possible enhancements of the
                          web project. With phpMaestro you don&apos;t just hire
                          someone to execute your project specification but much
                          more someone who helps you really make good and
                          sophisticated web project. The communication is greate
                          and feedback time very short. I really can&apos;t find
                          anything to criticise and will definitely rehire soon
                ...
                <div className="ClientSlideBx">
                  <div className="row">
                    ...
                    <div className="col-md-8">
                      <h4>Beano APP</h4>
                      <p>
                        &quot;Beano: Coffee ordering&quot; is an interactive application
                        for customers to find nearby coffee shops and place
                        order over app. This multilingual app (Android & iPhone)
                        facilitates customers to view their nearby coffee shops
                  ...
                  <div className="testimonial-country">
                    <div className="slide">
                      {/* <!--                        <div className="left_side_testi">
                            ...
                            <div className="cilent_name">
                                <span><strong className="flag"><Image width={100} height={100} unoptimized={true} src="/img/globalpages/swj.png" /></strong> seran91 </span>
                      ...
                      <div className="right_side_testi">
                        ...
                        <div className="cilent_text">
                          &quot;Everything was very good, they gave their best till
                          we was happy with the app. At the end of the project,
                          we had a great user friendly app.&quot;
                        </div>
                        <div className="cilent_name">
                          <span>
                            <strong className="flag">
                  ...
                  <div className="col-sm-6">
                    <div className="sectionset_iosands_col sectionset_iosands_colcon">
                      ...
                      <div className="descectionset_iosands">
                        ...
                        company portfolio, clien&apos;s reference and case studies

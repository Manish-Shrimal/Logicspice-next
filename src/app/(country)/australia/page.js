...
const Page = () => {
  ...
  return (
    <>
      <Navbar />
      <section className="country_header_secton aust">
            ...
            <div className="col-md-8">
              <div className="mobileapp_devcountry_bx_left">
                <h1 className="mobileapp_devcountry_bx_left_title">
                  Mobile App Development Company In <span>AUSTRALIA</span>
                </h1>
                <p style={{ textAlign: "justify" }}>
                  Logicspice is a leading mobile app development company
                  offering web & mobile app development services in Australia.
                  ...
                  a expert developers who are having years of experience to
                  convert your imagination into a a powerful app or website for
                  you and all your customers.
                </p>
                <p style={{ textAlign: "justify" }}>
                  We are one the most proficient app development company in
                  creating user friendly apps for all the major platforms. We
                  utilize advanced technology in the development process and
                  deliver great user experience. We have the skills and
                  experience to create both iOS and Android App.
                </p>
              </div>
            </div>
                ...
                <div className="ClientSlideBx">
                  <div className="row">
                    ...
                    <div className="col-md-8">
                      <h4>One Bed</h4>
                      <p>
                        &quot;Onebed&quot; serves the mattress purchasing
                        service. We have redeveloped the existing
                        website(WordPress) in the WordPress latest stable
                        version. This eCommerce website serves the marketing of
                        the mattresses where users can choose any variant that
                        they want,from the options of the mattress&apos;s variants
                        and can place an order for it by filling the mandatory
                        details over checkout page{" "}

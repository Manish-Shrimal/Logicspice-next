            ...
            <div className="row">
              <div className="col-xs-12 col-sm-6 col-md-4">
                <div className="laravel_service_box ">
                  ...
                  <p>
                    ...
                    insights&sbquo; helping large corporations and startups make
                    informed decisions.
                  </p>
                </div>
              </div>
              ...
              <div className="col-xs-12 col-sm-6 col-md-4">
                <div className="laravel_service_box ">
                  ...
                  <p>
                    Understand your audience with our tools. We analyze customer
                    behavior&sbquo; assisting brands in refining engagement
                    strategies.
                  </p>
                </div>
              </div>
              <div className="col-xs-12 col-sm-6 col-md-4">
                <div className="laravel_service_box ">
                  ...
                  <p>
                    Use predictive tools crafted by our team to guide proactive
                    business decisions.
                  </p>
                </div>
              </div>

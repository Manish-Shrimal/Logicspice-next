            ...
            <div className="row">
              <div className="col-xs-12 col-sm-6 col-md-6 laravel-banner-txt">
                ...
                <p>
                  ...
                  all the relevant information and graphics are in direct view.
                  It tweaks the layout so that the user is at ease while
                  navigating and reading through the page with reduced effort
                  usually involved in resizing&sbquo; scrolling and panning.
                </p>
              ...
              <div className="row">
                <div className="col-xs-12 col-sm-6 col-md-3">
                  <div className="laravel_service_box ">
                    ...
                    <h3>Self intuitive User Interface</h3>
                    <p>
                      We make sure that the layout is interactive and
                      intelligent so that it keeps the customer attached and
                      occupied.
                    </p>
                  </div>
                </div>
                <div className="col-xs-12 col-sm-6 col-md-3">
                  <div className="laravel_service_box ">
                    ...
                    <h3>Speedy Functionality</h3>
                    <p>
                      Speed and performance are one the foremost concerns for
                      our developers while designing a website.
                    </p>
                  </div>
                </div>
                ...
                <div className="col-xs-12 col-sm-6 col-md-3">
                  <div className="laravel_service_box ">
                    ...
                    <p>
                      Pages and sites developed through our services revamp and
                      resize themselves to suit the screen size they are being
                      used on.
                    </p>
                  </div>
                </div>
                <div className="col-xs-12 col-sm-6 col-md-3">
                  <div className="laravel_service_box ">
                    ...
                    <h3>Distinct Artworks and Graphic Works</h3>
                    <p>
                      We offer our clients with an arena within its own
                      workspace to provide with innovative and fresh ideas that
                      can be used on the web sites to suit the requirements.
                    </p>
                  </div>
                </div>
                ...
                <div className="col-xs-12 col-sm-6 col-md-3">
                  <div className="laravel_service_box ">
                    ...
                    <h3>Cross Browser capabilities</h3>
                    <p>
                      We design a page that can hold itself from the bugs and
                      faults while it is being used over different web browsers
                      on same or separate devices.
                    </p>
                  </div>
                </div>
                <div className="col-xs-12 col-sm-6 col-md-3">
                  <div className="laravel_service_box ">
                    ...
                    <h3>Multiple Devices Adaptability</h3>
                    <p>
                      Our websites are proficient in adapting themselves
                      according to the device's need whether it be an iOS or an
                      Android featuring platform.
                    </p>
                  </div>
                </div>
                <div className="col-xs-12 col-sm-6 col-md-3">
                  <div className="laravel_service_box ">
                    ...
                    <h3>Fluidity of Operations</h3>
                    <p>
                      We make sure that the cross platform and cross browser
                      usage of the website does not make it lose its fluidity
                      and simplicity.
                    </p>
                  </div>
                </div>
                <div className="col-xs-12 col-sm-6 col-md-3">
                  <div className="laravel_service_box ">
                    ...
                    <h3>Customizable Website Designs</h3>
                    <p>
                      We not only offer the best of the designs and layouts but
                      also make sure that there is enough room for the
                      creativity of our clients so that they can express their
                      own ideas through their web pages by customizing them.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              ...
              <div className="col-sm-6 col-md-4">
                <div className="featureBox">
                  ...
                  <p>
                    Screen can be smoothly adjusted&sbquo; as per your needs.
                  </p>
                </div>
              </div>
              <div className="col-sm-6 col-md-4">
        ...
        <section className="laravel_choose_features_section LaravelChooseFeaturesSection">
          <div className="container">
            ...
            <div className="laravel_choose_features_bx ReactJsChooseFeaturesBx">
              <div className="row">
                ...
                <div className="col-sm-6 col-md-6" data-aos="fade-left">
                  <div className="libraries_laravel_choose libraries_laravel_choose-right">
                    <div className="laravel_choose_details">
                      <p>
                        Our clients are fully satisfied with our responsive web
                        design services.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-sm-6 col-md-6" data-aos="fade-right">
                  <div className="libraries_laravel_choose">
                    <div className="laravel_choose_details">
                      <p>
                        Our motto is always satisfy our client 100% with our
                ...
                <div className="col-sm-6 col-md-6" data-aos="fade-left">
                  <div className="libraries_laravel_choose libraries_laravel_choose-right">
                    <div className="laravel_choose_details">
                      <p>
                        Our team has worked for the various industries i.e.
                        education‚ medical‚ entertainment and more.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-sm-12 main_btn_hire">
                <div className="btn btn-primary" onClick={openModal}>
                  <a>Hire Resposive Web Designer</a>
                  {
                    <Enquirymodal
                      modalStatus={showModal}
                      toggle={openModal}
                      title="Request To Hire Reposive Web Designer"
                    />
                  }
                </div>
              </div>

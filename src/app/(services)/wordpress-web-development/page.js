...
const Page = () => {
  ...
  return (
    <>
      <NavBar />
      <div className="wordpressWebdevelopment">
            ...
            <div className="row">
              ...
              <div className="col-sm-6 col-md-6 pull-left">
                <div className="laravel-descriptions-bx" dir="ltr">
                  ...
                  <p>
                    WordPress is one of the most prominent platforms when it
                    comes to Open Source content development system in the
                    world. <b>WordPress web development</b> is vastly used for
                    business and blog sites. WordPress website development is
                    well-known for its open source system which is user friendly
                    in nature&sbquo; it offers a wide-ranging directory of
                    essential plugins.
                  </p>
                  <p>
                    WordPress website design offers a very powerful and reliable
                    template framework with an easily accessible and
                    trouble-free executive dashboard. WordPress is a very
                    successful platform used for almost everything from creating
                    blogs to excessively functional ecommerce sites.
                  </p>
                  <p>
                    {" "}
                    At Logicspice&sbquo; we offer adept{" "}
                    <b>WordPress development services </b> by skilled
                    programmers who have experience in offering powerful and
                    smart WordPress development solutions for clients from all
                    over the world. WordPress website development services
                    include a wide range of services such as plug-ins
                    development&sbquo;
                    <Link href="/open-source-cms" target="_blank">
                      CMS development
                    </Link>
              ...
              <div className="row">
                ...
                <div className="col-xs-12 col-sm-6 col-md-3">
                  <div className="laravel_service_box ">
                    ...
                    <p>
                      Our job extends beyond our relationship which can be felt
                      by our 24/7 support and maintenance facility.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="col-sm-6 col-md-6" data-aos="fade-right">
                  <div className="libraries_laravel_choose">
                    ...
                    <div className="laravel_choose_details">
                      ...
                      <p>
                        WordPress enables its users to edit and update the
                        content as per business fundamentals.{" "}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-sm-6 col-md-6" data-aos="fade-left">
                  <div className="libraries_laravel_choose libraries_laravel_choose-right">
                    ...
                    <div className="laravel_choose_details">
                      ...
                      <p>
                        WordPress development services is highly secured and
                        user friendly. It comfortably runs on Linux&sbquo;
                        MacOSX and FreeBSD server.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-sm-6 col-md-6" data-aos="fade-left">
                  <div className="libraries_laravel_choose libraries_laravel_choose-right">
                    ...
                    <div className="laravel_choose_details">
                      ...
                      <p>
                        WordPress provides powerful and easy to use and
                        administer framework.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-sm-6 col-md-6" data-aos="fade-right">
                  <div className="libraries_laravel_choose">
                    ...
                    <div className="laravel_choose_details">
                      ...
                      <p>
                        WordPress provides 24x7 inclusive maintenance &
                        assistance services.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-sm-6 col-md-6" data-aos="fade-left">
                  <div className="libraries_laravel_choose libraries_laravel_choose-right">
                    ...
                    <div className="laravel_choose_details">
                      ...
                      <p>
                        WordPress offers appealing theme designs which are
                        vibrant and it adorns your ecommerce sites.
                      </p>
                    </div>
                  </div>
                </div>

              ...
              <div className="row">
                ...
                <div class="col-md-6">
                  <ul class="port_feat">
                    ...
                    <li>
                      <b>Overview:</b> “Sattvic Sage Solutions“ is a SaaS system
                      which will serve as an attractive medium for clinics to
                      manage their clients and their details. Customers will be
                      able to login and can manage their accounts, branches and
                      staff details with their roles over SaaS
                    </li>
                  </ul>
                </div>
              </div>

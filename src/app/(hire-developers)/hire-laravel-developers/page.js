              ...
              <div class="col-md-8">
                <div class="jumbotron">
                  ...
                  <p>
                    ...
                    finest{" "}
                    <a href="https://www.logicspice.com/laravel-development">
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12 text-center">
              <a onClick={toggleModal} className="btn btn-primary">
                <Contactusmodel modalStatus={modalOpen} toggle={toggleModal} title="Hire Laravel Developer"/>
                Hire Now!
              </a>
            </div>
          </div>
              ...
              <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                  <a
                    title="View Detail"
                    target="_black"
                    href="https://www.logicspice.com/hire-codeigniter-developers"
                  >
                    <div class="caption">
                      <div class="other-caption-bx">

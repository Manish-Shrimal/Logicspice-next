  ...
  <div class="container">
    <div class="row">
      <div class="col-md-7">
        ...
        <div class="SubTitle">
          Hire yii programmers from the hub of talented developers to attain
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="OurNewHirigPhpYii">
            ...
            <div class="">
              <p>
                Logicspice, one of the web development company offering cost
                effective solution to hire php yii developer for your project.
                Our team of dedicated yii framework developer has worked on
                multiple projects from small website to large enterprise
                websites. We offer advanced php yii solutions using the robust
                technology in yii development.
              </p>
              <p>
                Our yii programmers are helping you throughout the development
                process. Our team is proficient to keep client satisfied in
                terms of quality, uniqueness and functionality. By Hiring Yii
                developers, you will have a great experience working in a
                collaborative environment to evolve the application best in its
                class.
              </p>
              <p>
                You will get a skillful yii developer at logicspice for your yii
                php development needs. We always assure our clients for secure,
                cost effective, robust web and application development.
              </p>
            </div>
          </div>
        </div>
          ...
          <ul class="">
            <li class="">
              ...
              <div class="NewHireCustomTxt">
                ...
                <p>
                  Get a fast process for your web development as compare to
                  other MVC framework.
                </p>
              </div>
            </li>
            ...
            <li class="">
              ...
              <div class="NewHireCustomTxt">
                ...
                <p>
                  Build your eCommerce store in open source php framework with
                  lots of features.
                </p>
              </div>
            </li>
          ...
          <ul class="">
            ...
            <li class="">
              ...
              <div class="NewHireCustomTxt">
                ...
                <p>
                  Get web application developed for your business with our yii
                  developers.
                </p>
              </div>
            </li>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-4">
          <div class="WhyHireFromBx" data-aos="fade-up">
            ...
            <div class="WhyHireFromContent">Fast and easy communication</div>
          </div>
        </div>
        <div class="col-md-3 col-sm-4">
          <div class="WhyHireFromBx" data-aos="fade-up">
              ...
              <div class="CustomerReviewsBx">
                ...
                <div class="CustomerReviewsBxContent">
                  ...
                  <p>
                    ...
                    complicated and they tried their best to complete it with
                    the best diligence. I will definitely contact this company
                    in the future for my project updates and would recommend to
                    anyone who is looking for a good quality work.
                  </p>
                </div>
              </div>
              <div class="CustomerReviewsClient">
              ...
              <div class="CustomerReviewsBx">
                ...
                <div class="CustomerReviewsBxContent">
                  ...
                  <p>
                    ...
                    spirit, very flexible and understanding while maintaining
                    time and budget target.Top tear professional communication
                    and support.
                  </p>
                </div>
              </div>

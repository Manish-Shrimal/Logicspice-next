...
const Page = () => {
  ...
  const toggleModalImage = () => {
    setModalOpenImage((prevState) => !prevState);
  };

  const handleImageModal = (imagePath) => {
    setModalImage(imagePath);
    setModalOpenImage(true); // Ensure the modal opens
  };
    ...
    <>
      <div className="portifilo">
        ...
        <section className="sec_dv">
          <h2 className="hr_thy">
            We deliver cost effective and top-notch mobile app &amp; web
            solutions with ontime delivery and support.
          </h2>
        </section>
        ...
        <Modal
          show={modalOpenImage}
          onHide={toggleModalImage}
          size="lg" // Setting the size to extra-large
          style={{
            // width: "785px",
            // height: "auto",
            // position: "absolute",

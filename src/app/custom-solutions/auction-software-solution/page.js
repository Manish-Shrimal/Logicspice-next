...
const Page = () => {
  ...
  return (
    <>
      <Navbar />
      <div class="top-head-custom Auction-System">
        <div class="container">
          <div class="col-md-8">
        ...
        <div class="inner_content_SBG">
          <div class="container">
            ...
            <p>
              ...
              win the auction. Seller also have the facility to request buyer to
              withdraw any bid for a relevant reason.
            </p>
          </div>
        </div>
      </div>
      ...
      <section class="ecommerce_faq_section CustomSolutionFaqSection">
        ...
        <MDBAccordionItem
          ...
          <p>User can enter his zip/postal code in the website and all the products will be listed to the seller.</p>
        </MDBAccordionItem>

         <MDBAccordionItem
          headerTitle="How many days will it take to implement the development?"
          collapseId="flush-collapse2">
          <p>Time taken to implement your Auction Software depends on the level of customization and data migration. The time frame generally ranges from 5-6 weeks.</p>
        </MDBAccordionItem>

       <MDBAccordionItem
          headerTitle="Can a Seller upload multiple products to the website?"
          collapseId="flush-collapse3">
         <p>Yes, Sellers can add products in their Store along with multiple pictures and other details.</p>
        </MDBAccordionItem>

       <MDBAccordionItem
          headerTitle="Can a Seller set up multiple stores on the website?"
          collapseId="flush-collapse4">
          <p>No. A Seller can only setup one store in which he can upload multiple products.</p>
        </MDBAccordionItem>
       ...
       <MDBAccordionItem
          ...
          <p>Buyer can win the auction that he has bid for if they have the highest offer price at the end of auction.</p>
        </MDBAccordionItem>

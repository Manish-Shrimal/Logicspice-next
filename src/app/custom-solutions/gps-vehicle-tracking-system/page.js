  ...
  return (
    ...
    <div className="container">
        ...
        <div className="used_technology_section_dataa">
            <ul>
                <li data-aos="fade-up"><div className="icntechimg"><Image width={100} height={100} src="/img/customsolutions/tech_ios_icon.png" alt="iOS"/></div><div className="icntechimg_nm">iOS</div></li>
                <li data-aos="fade-up"><div className="icntechimg"><Image width={100} height={100} src="/img/customsolutions/tech_java_icon.png" alt="Java"/></div><div className="icntechimg_nm">Java</div></li>
                <li data-aos="fade-up"><div className="icntechimg"><Image width={100} height={100} src="/img/customsolutions/tech_android_icon.png" alt="Android"/></div><div className="icntechimg_nm">Android</div></li>
                <li data-aos="fade-up"><div className="icntechimg"><Image width={100} height={100} src="/img/customsolutions/tech_php_icon.png" alt="PHP"/></div><div className="icntechimg_nm">PHP</div></li>
                <li data-aos="fade-up"><div className="icntechimg"><Image width={100} height={100} src="/img/customsolutions/tech_cakephp_icon.png" alt="CakePHP"/></div><div className="icntechimg_nm">CakePHP</div></li>
                <li data-aos="fade-up"><div className="icntechimg"><Image width={100} height={100} src="/img/customsolutions/tech_bootstrap_icon.png" alt="Bootstrap"/></div><div className="icntechimg_nm">Bootstrap</div></li>
                <li data-aos="fade-up"><div className="icntechimg"><Image width={100} height={100} src="/img/customsolutions/tech_mysql_icon.png" alt="MySQL"/></div><div className="icntechimg_nm">MySQL</div></li>
                <li data-aos="fade-up"><div className="icntechimg"><Image width={100} height={100} src="/img/customsolutions/tech_apache_icon.png" alt="Apache"/></div><div className="icntechimg_nm">Apache</div></li>
            </ul>
        </div>
    </div>
</div>--> */}

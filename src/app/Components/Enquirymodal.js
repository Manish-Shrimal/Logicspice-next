      ...
      <div className="modal-dialog " role="document" onClick={stopPropagation}>
        {/* <div className="modal-content ModalContentEnqury"> */}
          ...
          >
            ...
            <img src="https://www.logicspice.com/app/webroot/img/images/close-img.png" alt="logo"/>
          </button>
                  ...
                  >
                    <div className="modal-body">
                      ...
                      <div className="form-group">
                        ...
                        <div className="FormError">{formErrors.emailerror}</div>
                      </div>
                      <div className="form-group">
                        <div className="input-group">
                          <span className="input-group-text">
                        ...
                        <div className="FormError">{formErrors.phoneerror}</div>
                      </div>
                      <div className="form-group">
                        <div className="input-group">
                          <span className="input-group-text">

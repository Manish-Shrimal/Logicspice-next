  ...
  return (
    <>
      {/* <Slider {...settings}>
        ...
        <li>
                        <figure>
                            <img src="https://www.logicspice.com/app/webroot/files/blogs/thumb/be5ea_Best-PHP-Frameworks.jpg" class="lazy" alt="10 Best PHP Frameworks for Web Developers"/>                            <figcaption>

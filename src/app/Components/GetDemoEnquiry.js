...
const Enquirymodal = ({ modalStatus, toggle, title }) => {
  ...
  const submitEnquiryForm = async (e) => {
    ...
    if (formData.phone_no && !/^\d{1,15}$/.test(formData.phone_no)) {
      newErrors.phone_no = "Phone number should not exceed 15 digits and must be numeric";
    }
                      ...
                      <div className="modal-content ModalContentEnqury">
                        <div id="show_demo" className="show_fixxx">
                          <form>
                            ...
                            {!resultSuccess && (
                              <div className="modal-footer get_demo_modal pt-0 ">
                                <div className="buttonArea">
                                  ...
                                  <p>
                                    (Receive the access to demo details in your
                                    email)
                                  </p>
                                </div>
                    ...
                    <div className="col-md-5">
                      ...
                      <div className="ls-google-swction">
                        ...
                        <p id="review_msg">
                          ...
                          patience they showed, extremely swift turnaround
                          times, good value for money and quality of work, they
                          have shown to be a great partner.
                        </p>

...
const faqData = [
  ...
  },
  {
    question: 'Will I be updated regularly during the project?',
    answer:
      'Absolutely. You’ll get regular updates and can track progress through tools like Trello or Jira. We want you to feel involved and confident from start to finish.',
  },
  {
    question: 'What if I need changes after the project is live?',
    answer:
...
const FAQ = () => {
  const [openIndex, setOpenIndex] = useState(null); // Open first item by default
            ...
            {faqData.map((faq, index) => (
              ...
              >
                ...
                {openIndex === index && (
                  ...
                  >
                  <div className="faq-answer" data-aos="fade-up">
                    {faq.answer}
                  </div>
                  </div>
                )}

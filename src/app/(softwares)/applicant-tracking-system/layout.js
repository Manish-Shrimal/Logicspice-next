...
export async function generateMetadata({ params }) {
  ...
  try {
    ...
    const response = await fetch(`${MetadataApi}/applicant-tracking-system`, { cache: "no-store" });
    ...
    return {
      ...
      openGraph: {
        ...
        url: `${Domain}/applicant-tracking-system`,
        type: "website",
        images: [
          {
            url:
              og_image ||
              `${Domain}/img/applicant-tracking-system/applicant-tracking-banner-img.png`,
            // width: 1200,
            // height: 630,
      ...
      twitter: {
        card: `${Domain}/img/applicant-tracking-system/applicant-tracking-banner-img.png`,
        title: meta_title || "Default Twitter Title",
        description: meta_description || "Default Twitter Description",
        images: [
          og_image || `${Domain}/img/applicant-tracking-system/applicant-tracking-banner-img.png`,
        ],
      },
      robots: {
        index: true,
    ...
    return {
      ...
      alternates: { canonical: `${Domain}/applicant-tracking-system `},
      openGraph: {
        ...
        images: [
          {
            url: `${Domain}/img/applicant-tracking-system/applicant-tracking-banner-img.png`,
            // width: 1200,
            // height: 630,

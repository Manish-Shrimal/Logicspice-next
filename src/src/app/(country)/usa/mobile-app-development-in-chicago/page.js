...
const Page = () => {
  ...
  return (
    <>
      {" "}
      <Navbar />
      <section className="country_header_secton chicago">
            ...
            <div className="col-md-8">
              <div className="mobileapp_devcountry_bx_left">
                <h1 className="mobileapp_devcountry_bx_left_title">
                  Mobile App Development Company In <span>Chicago</span>
                </h1>
                <p style={{ textAlign: "justify" }}>
                  ...
                  chicago and all other mazor countries. Our expert app
